...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Rest_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Rest_t qt_meta_stringdata_Rest = {
    {
QT_MOC_LITERAL(0, 0, 4) // "Rest"
...
const QMetaObject Rest::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Rest.data,
      qt_meta_data_Rest,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Rest::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Rest.stringdata0))
        return static_cast<void*>(const_cast< Rest*>(this));
